                ...
                html.Div(
                    ...
                    children = [
                        html.Div(
                            ...
                            children=[
                                html.H4('What is your itinerary?',style={"margin-left": "15px"}),
                        ...
                        html.Div(
                            ...
                            children=[
                                ...
                                dcc.Slider(
                                    ...
                                    max=max(METERS),
                                    value=min(METERS),
                                    marks={str(dist): dict(label=str(dist), style={"color": "#7fafdf"}) for dist in
                                           METERS},
                                    step=None,
                                ),
                            ],
...
def return_poi(selected_poi):
    ...
    text = "What additional distance are you ok to do to avoid a {} ?".format(poi_dict[selected_poi])
    return text
